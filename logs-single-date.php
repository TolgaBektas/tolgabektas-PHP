...
$simdikiSayfa='Loglar / Tek Tarih Sorgulama';
...
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-md-12">
				<h3 class="card-title">Tek Tarih Girişler</h3>
			</div>
		...
		<form method="POST">
			<div class="row">			
				<div class="form-group col-md-6">
					<label for="adsoyad">Tarih</label>
					<input type="date" class="form-control" id="adsoyad" required="" name="ay">
				</div>
				<div class="form-group col-md-6">
				</div>
				<div class="form-group col-md-6">
